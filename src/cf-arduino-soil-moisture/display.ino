...
void displayRenderMainPage() {
    ...
    display.drawBitmap(0, 0, displayNetworkIcon8x7, 8, 7, 1);                                       // Network.
    display.drawBitmap(96, 0, displayPhoneIcon8x7, 8, 7, 1);                                        // Things Board.
    display.drawBitmap(8, 24, displayHumidityIcon8x7, 8, 7, 1);                                     // Moisture.
    ...
    String moistureValue = String(getSoilMoistureValue());
    String moisturePercentage = String(getSoilMoisturePercentage());
    String moisture = moisturePercentage + "% (" + moistureValue + ")";
    for (int i = moisture.length(); i < 11; i++) {
        moisture += " ";
    }
